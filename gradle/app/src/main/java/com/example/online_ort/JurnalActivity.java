...
public class JurnalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapter1 = new CustomAdapter(JurnalActivity.this, this, jurnal_id, jurnal_correct, jurnal_count, jurnal_count_max, jurnal_count_question, jurnal_time, jurnal_correct, jurnal_correct);
